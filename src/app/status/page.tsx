    ...
    <>
      ...
      <Section tone="white" className="pt-(--spacing-section-sm)">
        <Container className="max-w-4xl">
          {/* Overall banner */}
          <Reveal>
            <div className="mb-8 flex items-center gap-4 rounded-(--radius-shell) border border-emerald-200 bg-emerald-50/70 px-6 py-5">
          ...
          {/* Services */}
          <ul className="overflow-hidden rounded-(--radius-shell) border border-line bg-surface shadow-hairline">
            {STATUS_SERVICES.map((service, i) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="truncate text-[0.8125rem] text-muted">{service.description}</p>
                </div>
          ...
          {/* Incident contact */}
          <Reveal delay={0.1}>
            <div className="mt-8 flex flex-col items-center justify-between gap-4 rounded-(--radius-shell) border border-line bg-surface-tint px-6 py-5 text-center sm:flex-row sm:text-left">
