            ...
            <Reveal>
              <article
                ...
                className={[
                  ...
                  "[&_h2]:mt-12 [&_h2]:scroll-mt-28 [&_h2]:text-display-sm [&_h2]:text-ink first:[&_h2]:mt-0",
                  "[&_h3]:mt-8 [&_h3]:text-[1.0625rem] [&_h3]:font-semibold [&_h3]:text-ink",
                  "[&_p]:mt-4 [&_p]:text-[0.9375rem] [&_p]:leading-relaxed [&_p]:text-body",
                  "[&_ul]:mt-4 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-6 [&_li]:text-[0.9375rem] [&_li]:leading-relaxed [&_li]:text-body",
                  ...
                  "[&_th]:border-b [&_th]:border-line-strong [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:font-semibold [&_th]:text-ink",
                  "[&_td]:border-b [&_td]:border-line [&_td]:px-3 [&_td]:py-2 [&_td]:text-body",
