...
const badgeVariants = cva(
  "inline-flex items-center gap-1.5 rounded-full font-mono uppercase tracking-[0.14em]",
  {
    variants: {
      variant: {
        default: "border border-line bg-surface-tint px-3 py-1 text-[0.68rem] text-muted",
        brand: "border border-brand-200 bg-brand-50 px-3 py-1 text-[0.68rem] text-brand-700",
        ...
        chip: "border border-line bg-surface px-2.5 py-1 text-[0.7rem] normal-case tracking-normal font-sans text-body",
      },
    },
    defaultVariants: {
      variant: "default",
